...
DOCUMENTED_STATUS_CODES: dict[str, dict[tuple[str, str], tuple[str, ...]]] = {
    ...
    "fake-pvs": {
        ...
        ("POST", "/v1/clinical-documents"): ("200", "201", "409", "422", "503", "504"),
        ("GET", "/v1/clinical-documents/{document_id}"): ("200", "404"),
        ("GET", "/v1/admin/events"): ("200",),
        ("PUT", "/v1/admin/faults"): ("200",),
        ("POST", "/v1/admin/reset"): ("200",),
    },
...
RESPONSE_REQUIRED_FIELDS: dict[
    ...
    "fake-pvs": {
        ...
        ("POST", "/v1/clinical-documents", "201"): (
            "id",
            "synthetic_patient_id",
            "synthetic_visit_id",
            "document_ref",
        ...
        ("GET", "/v1/clinical-documents/{document_id}", "200"): (
            "id",
            "synthetic_patient_id",
            "synthetic_visit_id",
            "document_ref",
